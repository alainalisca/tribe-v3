/** Base translation keys — navigation, common, sessions, profile, settings, auth, chat */
export const baseEn = {
  // Navigation
  home: 'Home',
...
export const baseEs: Record<keyof typeof baseEn, string> = {
  // Navegacion
  home: 'Inicio',
  ...
  tryDifferentSearch: 'Se el primero! Crea una sesión y nunca entrenes solo.',
  confirm: 'Confirmar',
  back: 'Volver',
  retry: 'Reintentar',
  minutes: 'minutos',
  ...
  location: 'Ubicación',
  maxParticipants: 'Máximo de Atletas',
  ...
  sessionFullMsg: 'Esta sesión esta llena',
  ...
  howWasYourExperience: 'Como fue tu experiencia con el anfitrión?',

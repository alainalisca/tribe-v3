...
export async function joinChallenge(supabase: SupabaseClient, challengeId: string, userId: string): Promise<DalResult<null>> {
  try {
    // Insert participant
...
export async function leaveChallenge(supabase: SupabaseClient, challengeId: string, userId: string): Promise<DalResult<null>> {
  try {
    // Delete participant

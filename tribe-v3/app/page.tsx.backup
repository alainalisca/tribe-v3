    ...
    <div className="min-h-screen pb-20 bg-tribe-darker">
      ...
      <div className="bg-tribe-dark p-4 border-b border-slate-700">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          <div className="w-10 h-10 bg-tribe-dark rounded-lg flex items-center justify-center border-2 border-tribe-green">
            <span className="text-2xl font-black text-white">T</span>
          </div>
          <h1 className="text-2xl font-black text-white">
            TRIBE
            <span className="text-tribe-green">.</span>
          </h1>
        </div>
      </div>
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-tribe-darker border border-slate-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-tribe-green"
            />
            {searchQuery && (
              <button
      ...
      <div className="max-w-2xl mx-auto p-4">
        {loading ? (
          ...
          <div className="bg-tribe-dark rounded-xl p-8 text-center border border-slate-700">
            <p className="text-gray-400 mb-2">{t('noSessionsFound')}</p>

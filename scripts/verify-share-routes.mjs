 ...
 *   5. every <a> the page offers leads somewhere that is not an App Store
 *      bounce -- /download/index.html navigates to the store 300ms after load
 *
...
for (const t of TARGETS) {
  ...
  console.log(`  links        : ${[...new Set(r.links)].join(', ')}`);

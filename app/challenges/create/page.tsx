    ...
    <div className="min-h-screen bg-theme-page pb-12">
      ...
      <div className="pt-header max-w-2xl mx-auto p-4">
        <form
          ...
          className="bg-white dark:bg-[#272D34] rounded-2xl p-6 border border-stone-200 dark:border-gray-700 space-y-5"
        >
          {/* Title */}
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-stone-50 dark:bg-[#3D4349] border border-stone-200 dark:border-gray-600 rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:ring-2 focus:ring-tribe-green"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-stone-50 dark:bg-[#3D4349] border border-stone-200 dark:border-gray-600 rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:ring-2 focus:ring-tribe-green resize-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              min="1"
              className="w-full px-4 py-3 bg-stone-50 dark:bg-[#3D4349] border border-stone-200 dark:border-gray-600 rounded-lg text-theme-primary focus:outline-none focus:ring-2 focus:ring-tribe-green"
            />
          </div>
          ...
          <div>
            ...
            >
              <option value="">
                {language === 'es' ? 'Seleccionar deporte' : 'Select sport'}
              </option>
              {sports.map((sport) => (
                <option
                  key={sport}
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-tribe-green text-slate-900 font-semibold rounded-lg px-6 py-3 hover:bg-[#8FD642] disabled:opacity-50 transition mt-6"
          >

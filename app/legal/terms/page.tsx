    ...
    <div className="min-h-screen bg-stone-50 dark:bg-[#52575D] safe-area-top">
      <div className="bg-stone-200 dark:bg-[#272D34] p-4 border-b border-stone-300 dark:border-black">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-stone-900 dark:text-white">Terms of Service</h1>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-[#272D34] rounded-xl p-8">
          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                By accessing, downloading, or using the Tribe mobile application, website, or related services
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                If you do not agree to these Terms, you must not access or use Tribe.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                By creating an account, you represent and warrant that all information you provide is true, accurate,
                and complete.
              </p>
              <p className="text-sm italic text-stone-600 dark:text-gray-400">
                Tribe is operated by A Plus Fitness LLC, a New York limited liability company, and is currently in beta
                testing in Medellín, Colombia.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                Tribe is a digital platform designed to help users connect for sports, fitness, and training activities.
                Tribe facilitates introductions and coordination between users, but Tribe is not a service provider,
                employer, agent, or guarantor of any activity arranged through the Platform.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2 text-stone-700 dark:text-gray-300 mb-3">
                ...
                <li>
                  Tribe does not oversee, monitor, or control the actions or conduct of any users, whether during
                  in-person activities or communications via the Platform.
                </li>
                <li>All users act independently and at their own risk.</li>
              </ul>
              <p className="text-sm italic text-stone-600 dark:text-gray-400">
                While Tribe may be accessed internationally, these Terms are governed by U.S. law and the Platform is
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 dark:text-white mb-3">
                4. HEALTH AND ASSUMPTION OF RISK
              </h2>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                Physical activity and sports inherently involve risk, including but not limited to serious injury,
                permanent disability, or death. By participating in any activity arranged through Tribe, you agree that:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-stone-700 dark:text-gray-300 mb-3">
                ...
                <li>
                  Tribe is not liable for any injuries, accidents, property damage, or losses arising out of or related
                  to participation in any activity coordinated via the Platform.
                </li>
              </ul>
              <p className="text-stone-700 dark:text-gray-300">
                Tribe disclaims all warranties, express or implied, regarding safety, suitability, or outcomes of any
                activities or sessions arranged through the Platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                You agree to use the Platform responsibly and lawfully. You must not:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-stone-700 dark:text-gray-300 mb-3">
              ...
              <p className="text-stone-700 dark:text-gray-300">
                Tribe reserves the right to investigate and take appropriate legal or administrative action (including
            ...
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                <strong>Between Users:</strong> Tribe is not responsible for mediating or resolving disputes between
                users. You must resolve any disputes directly.
              </p>
              <p className="text-stone-700 dark:text-gray-300">
                <strong>With Tribe:</strong> These Terms and any dispute with Tribe shall be governed by and construed
                in accordance with the laws of the State of New York, United States, without regard to its conflict of
                laws principles. You agree to submit to the exclusive jurisdiction of the state and federal courts
            ...
            <section>
              ...
              <p className="text-stone-700 dark:text-gray-300 mb-3">
                Questions, legal concerns, or requests regarding these Terms may be directed to:
              </p>

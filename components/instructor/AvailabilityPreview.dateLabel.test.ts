...
/**
 * AvailabilityPreview used to carry a private formatDayLabel that parsed the bare
 * YYYY-MM-DD as UTC midnight and rendered with timeZone UTC and
 ...
 * the swap. The witness proves the zone override is live.
 */
...
describe('AvailabilityPreview date label', () => {
  it('matches the retired formatDayLabel output byte for byte under America/Bogota', () => {

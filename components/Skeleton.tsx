export function SkeletonCard() {
  return (
    <div className="bg-white dark:bg-tribe-card rounded-xl p-4 shadow animate-pulse">
      <div className="flex items-center justify-between mb-3">
        <div className="h-8 w-24 bg-stone-200 dark:bg-tribe-mid rounded-full"></div>
        <div className="h-6 w-16 bg-stone-200 dark:bg-tribe-mid rounded"></div>
      </div>
      <div className="space-y-2 mb-3">
        <div className="h-4 bg-stone-200 dark:bg-tribe-mid rounded w-3/4"></div>
        <div className="h-4 bg-stone-200 dark:bg-tribe-mid rounded w-1/2"></div>
        <div className="h-4 bg-stone-200 dark:bg-tribe-mid rounded w-2/3"></div>
      </div>
      <div className="flex items-center gap-2 mb-3">
        <div className="h-8 w-8 bg-stone-200 dark:bg-tribe-mid rounded-full"></div>
        <div className="h-4 bg-stone-200 dark:bg-tribe-mid rounded w-32"></div>
      </div>
      <div className="h-10 bg-stone-200 dark:bg-tribe-mid rounded-lg"></div>
    </div>
  );
}

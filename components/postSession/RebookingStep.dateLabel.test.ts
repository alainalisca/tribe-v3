...
/**
 * RebookingStep used to carry a private formatDay that parsed the bare
...
describe('RebookingStep date label', () => {
  it('matches the retired formatDay output byte for byte under America/Bogota', () => {

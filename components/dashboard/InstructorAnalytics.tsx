    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        {cards.map((card) => (
          <div
            key={card.label}
            className="p-4 bg-white dark:bg-[#3D4349] rounded-xl border border-stone-200 dark:border-[#52575D]"
          >
      ...
      {/* Monthly Trend */}
      <div className="p-4 bg-white dark:bg-[#3D4349] rounded-xl border border-stone-200 dark:border-[#52575D]">

      ...
      {editing && (
        <div className="p-4 bg-white dark:bg-tribe-surface rounded-xl border-2 border-tribe-green space-y-3">
          <input
            ...
            className="w-full px-3 py-2 rounded-lg bg-stone-50 dark:bg-tribe-dark border border-stone-200 dark:border-tribe-mid text-theme-primary text-sm outline-none focus:ring-2 focus:ring-tribe-green"
          />
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-2 rounded-lg bg-stone-50 dark:bg-tribe-dark border border-stone-200 dark:border-tribe-mid text-theme-primary text-sm outline-none focus:ring-2 focus:ring-tribe-green resize-none"
          />
      ...
      {packages.length === 0 && !editing ? (
        ...
        <div className="space-y-3">
          {packages.map((pkg) => (
            <div
              key={pkg.id}
              className="p-4 bg-white dark:bg-tribe-surface rounded-xl border border-stone-200 dark:border-tribe-mid flex items-center justify-between"
            >
